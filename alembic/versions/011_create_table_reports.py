...
def upgrade() -> None:
    ...
    op.create_table(
        'table_report_rows',
        sa.Column('id', sa.Integer(), primary_key=True, autoincrement=True),
        sa.Column('report_id', sa.Integer(), sa.ForeignKey(
            f'{schema}.table_reports.id', ondelete='CASCADE'), nullable=False, index=True),
    ...
    op.create_table(
        ...
        sa.Column('row_id', sa.Integer(), sa.ForeignKey(
            f'{schema}.table_report_rows.id', ondelete='CASCADE'), nullable=False, index=True),
